				...
				<div class="col-lg-4 col-md-6">
					<div class="footer-widget mb-5 mb-md-0">
						...
						<div class="latest-blog">
							<div class="lb-item">
								<div class="lb-thumb set-bg" data-setbg="{{Asset('Asset/frontend/img/latest-blog/1.jpg')}}"></div>
							...
							<div class="lb-item">
								<div class="lb-thumb set-bg" data-setbg="{{Asset('Asset/frontend/img/latest-blog/2.jpg')}}"></div>
								<div class="lb-content">
									<div class="lb-date">June 21, 2018</div>
									<p>Lorem ipsum dolor sit amet, consectetur adipisc ing ipsum </p>
									<a href="#" class="lb-author">By Admin</a>
							...
							<div class="lb-item">
								<div class="lb-thumb set-bg" data-setbg="{{Asset('Asset/frontend/img/latest-blog/3.jpg')}}"></div>
								<div class="lb-content">
									<div class="lb-date">June 21, 2018</div>
									<p>Lorem ipsum dolor sit amet, consectetur adipisc ing ipsum </p>
									<a href="#" class="lb-author">By Admin</a>
				...
				<div class="col-lg-4 col-md-6">
					<div class="footer-widget">
						...
						<div class="top-comment">
							<div class="tc-item">
								<div class="tc-thumb set-bg" data-setbg="{{Asset('Asset/frontend/img/authors/1.jpg')}}"></div>
							...
							<div class="tc-item">
								<div class="tc-thumb set-bg" data-setbg="{{Asset('Asset/frontend/img/authors/2.jpg')}}"></div>
								<div class="tc-content">
									<p><a href="#">James Smith</a> <span>on</span>  Lorem ipsum dolor sit amet, co</p>
									<div class="tc-date">June 21, 2018</div>
								</div>
							...
							<div class="tc-item">
								<div class="tc-thumb set-bg" data-setbg="{{Asset('Asset/frontend/img/authors/3.jpg')}}"></div>
								<div class="tc-content">
									<p><a href="#">James Smith</a> <span>on</span>  Lorem ipsum dolor sit amet, co</p>
									<div class="tc-date">June 21, 2018</div>
								</div>
							...
							<div class="tc-item">
								<div class="tc-thumb set-bg" data-setbg="{{Asset('Asset/frontend/img/authors/4.jpg')}}"></div>
								<div class="tc-content">
									<p><a href="#">James Smith</a> <span>on</span>  Lorem ipsum dolor sit amet, co</p>
									<div class="tc-date">June 21, 2018</div>
								</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<!--====== Javascripts & Jquery ======-->
	<script src="{{Asset('Asset/frontend/js/jquery-3.2.1.min.js')}}"></script>
	<script src="{{Asset('Asset/frontend/js/bootstrap.min.js')}}"></script>
	<script src="{{Asset('Asset/frontend/js/owl.carousel.min.js')}}"></script>
	<script src="{{Asset('Asset/frontend/js/jquery.marquee.min.js')}}"></script>
